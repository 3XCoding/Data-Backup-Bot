...
PICS = (environ.get('PICS' ,'https://telegra.ph/file/401e49ed99bc9a8c4e62c.png')).split()
MELCOW_PIC = (environ.get('MELCOW_PIC' ,'https://telegra.ph/file/e496e2300bedb2c776d01.png')).split()
...
START_TXT = environ.get("START_TXT", "<b>🙋🏻‍♂️ 𝙷𝙸 {mention}</b>\n\n𝙼𝚈 𝙽𝙰𝙼𝙴 𝙸𝚂 {bot_name},\n𝙸 𝙲𝙰𝙽 𝙿𝚁𝙾𝚅𝙸𝙳𝙴 𝙼𝙾𝚅𝙸𝙴𝚂, 𝙹𝚄𝚂𝚃 𝙰𝙳𝙳 𝙼𝙴 𝚃𝙾 𝚈𝙾𝚄𝚁 𝙶𝚁𝙾𝚄𝙿 𝙰𝙽𝙳 𝙼𝙰𝙺𝙴 𝙼𝙴 𝙰𝙳𝙼𝙸𝙽. 𝙵𝙾𝙻𝙻𝙾𝚆 𝚃𝙷𝙴 𝙱𝙾𝚃 𝚃𝙸𝙿𝚂...\n\n<b>🧑🏻‍💻 𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𝙱𝚈:</b> @VijayAdithyaa")
